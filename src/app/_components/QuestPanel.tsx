...
export default function QuestPanel(props: Props) {
	return (
		<div className="bg-blue-50 border border-blue-200 rounded-lg shadow-md w-80 h-56 px-4 pt-2 pb-4 flex flex-col gap-2 transition-all hover:shadow-lg hover:opacity-90">
